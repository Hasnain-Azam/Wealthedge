    ...
    <div className="min-h-screen bg-gradient-to-br from-green-100 via-teal-50 to-blue-50 flex items-center justify-center px-6">
      <div className="grid md:grid-cols-2 items-center gap-10 max-w-5xl w-full">
        ...
        <div className="space-y-6">
          <h1 className="text-3xl font-bold">Own your money with clarity.</h1>
          <p className="text-gray-600">
            Sign in to track spending, understand trends, and keep your investing ramp on pace.
          </p>
        ...
        <div className="bg-white shadow-lg rounded-2xl p-8">
          <h2 className="text-2xl font-semibold mb-6 text-center">Sign in to WealthEdge</h2>
